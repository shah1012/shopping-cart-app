...
function Navbar({ isCart }) {
  ...
  //useEffect to fetch the total number of items!
  useEffect(() => {
    ...
    <div>
      {isCart ? (
        <div className="navbar__cartdiv">
          <Link to="/">
            <button className="navbar__button">Back</button>
          </Link>
          <h1 className="navbar__title">Shopping Cart</h1>
        </div>
      ) : (
        <div className="navbar__homediv">
          <h1 className="navbar__title">Shopping </h1>
          <Link to="/cart">
            <div className="container__icon">
              ...
              />
              <div className="circle">{totalItems}</div>
            </div>
          </Link>
        </div>
      )}
